...
class VFNet(nn.Module):
    def __init__(self, nf=64, nframes=5, groups=8, front_RBs=5, back_RBs=10, center=None,upscale_factor=4):
        ...
        self.HRconv = nn.Conv2d(64,3,3,1,1,bias=True)
    ...
    def forward(self,x):
        ...
        fusion = self.ca_fusion(aligned_fea)#B,N*C,H,W
        out = self.recon_first(fusion)
